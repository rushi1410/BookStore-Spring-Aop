...
public class UserController {
    ...
    //localhost:8083/user/getToken/{email}
    ...
    //localhost:8083/user/getByToken/{token}
    ...
    //localhost:8083/user/changepassword
